...
const profileAvatarBtn = document.querySelector("#profile__avatar-update-button"); //кнопка редактирования профиля
...
const nameInput = document.querySelector("#popup__input-name"); //поле редактирование имени пользовате
const jobInput = document.querySelector("#popup__input-status"); //поле редактирование  job пользователя
